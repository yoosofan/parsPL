...
keywords =('IF' , 'WHILE', 'ELSE', 'FUNCTION' )
persian_keywords = {
  '.اگر' : "IF",
  '.وگرنه' : "ELSE",
  '.تا'   : "WHILE" ,
...
tokens  = keywords + (
    ...
    'LBRACE','RBRACE', 'LITERAL','COMMENT', 'COMMA'
    )
...
def p_statement_definitionOfFunction(p):
  'statement : FUNCTION ID LPAREN RPAREN suite'
  p[0]=common.StmtCls('def_func',p.lexer.lineno, [p[1],p[3]])
